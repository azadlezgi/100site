...
$catalog_say = dbcount("(catalog_id)", DB_CATALOG);
if ($catalog_say) { echo $locale['271'] ." ". $catalog_say ."<br />"; }

$catalog_cat_say = dbcount("(catalog_cat_id)", DB_CATALOG_CATS);
if ($catalog_cat_say) { echo $locale['272'] ." ". $catalog_cat_say ."<br />"; }

$arlicles_say = dbcount("(article_id)", DB_ARTICLES);
if ($arlicles_say) { echo $locale['273'] ." ". $arlicles_say ."<br />"; }

$arlicle_cat_say = dbcount("(article_cat_id)", DB_ARTICLE_CATS);
if ($arlicle_cat_say) { echo $locale['274'] ." ". $arlicle_cat_say ."<br />"; }

$page_say = dbcount("(page_id)", DB_CUSTOM_PAGES);
if ($page_say) { echo $locale['275'] ." ". $page_say ."<br />"; }

$news_say = dbcount("(news_id)", DB_NEWS);
if ($news_say) { echo $locale['276'] ." ". $news_say ."<br />"; }
