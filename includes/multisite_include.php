...
// define("DB_NEWS_CATS", $_SERVER['DOCUMENT_ROOT'] . $_SERVER['PHP_SELF']);
...
define("DB_CATALOG", DB_PREFIX."catalog");
define("DB_CATALOG_CATS", DB_PREFIX."catalog_cats");
define("DB_CATALOG_PGROUP", DB_PREFIX."catalog_pgroup");
define("DB_CATALOG_PPARAM", DB_PREFIX."catalog_pparam");
define("DB_CATALOG_PVALUE", DB_PREFIX."catalog_pvalue");

define("DB_LANGUAGES", DB_PREFIX."languages");
define("DB_CURRENCY", DB_PREFIX."currency");
define("DB_COMPONENTS", DB_PREFIX."components");
define("DB_SEOURL", DB_PREFIX."seourl");
